...
type ICore interface {
	...
	NewOpinionatedSubscriber(ctx context.Context, id string, subscription *subscription.Model, partiton int, computedHash int, timeoutInMs int, maxOutstandingMessages int64, maxOutstandingBytes int64,
		requestCh chan *PullRequest, ackCh chan *AckMessage, modAckCh chan *ModAckMessage) (ISubscriber, error)
}
