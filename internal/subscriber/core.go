...
func (c *Core) NewSubscriber(ctx context.Context, subscriberID string, subscription string, timeoutInSec int, maxOutstandingMessages int64, maxOutstandingBytes int64) (ISubscriber, error) {
